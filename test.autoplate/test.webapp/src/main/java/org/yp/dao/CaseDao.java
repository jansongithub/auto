...
//                        java.sql.Types.VARCHAR, java.sql.Types.INTEGER}
    ...
    /*
     *查询用例执行结果
     *retrun   CasePo   ResultPo
     */
    @SuppressWarnings("unchecked")
    public List<String> getTestcaseResult() {
        final List listresult = new ArrayList();

        String sql = "select t.ID,t.apiName,t.testcaseName,t.projectName,t.call_type,t.host,t.call_suff,t.Accept,\n" +
                "t.Content_Type,t.IsLogin,t.user,t.BeforeSqlType,t.BeforeSql,t.Body,t.AfterSqlType,t.AfterSQL,\n" +
                "t.ResultResponseType,t.ResultResponse,b.Result_Status from apitest.testcase t,apitest.test_result b where t.id = b.testcase_id";
        return super.getJdbcTemplate().query(sql, new RowMapper() {
            ...
            public Object mapRow(ResultSet rs, int num) throws SQLException {
                ...
                testcase.setResultResponse(rs.getString("ResultResponse"));
                resultPo.setResult_Status(rs.getString("Result_Status"));
                listresult.add(testcase);
                listresult.add(resultPo);
                return listresult;
            }
        });
